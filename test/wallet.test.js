const wallet = require("../public/javascripts/wallet");
...
describe("Wallet", function () {
    ...
    describe("keys_to_format", function () {
        it('should return an object with the properties sk and vk', function () {
            keys = wallet.generate_keys();
            fkeys = wallet.keys_to_format(keys);
    ...
    describe('format_to_keys', function () {
        it('should return an object with the properties sk and vk', function () {
            keys = wallet.new_wallet();
            reskeys = wallet.format_to_keys(keys.sk);
        ...
        it('should return vk from sk matching original vk', function () {
            keys = wallet.new_wallet();
            reskeys = wallet.format_to_keys(keys.sk);
            freskeys = wallet.keys_to_format(reskeys);
